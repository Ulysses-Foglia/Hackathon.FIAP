...
INSERT INTO TAREFAS VALUES (GETDATE(), 'Criar aplicação', 4, 'd', 'EmAndamento', '26/04/2024 10:00:00', '30/04/2024 10:00:00', 
(SELECT ID FROM USUARIOS WHERE NOME = 'UsuTeste1'), (SELECT ID FROM USUARIOS WHERE NOME = 'UsuTeste2'))
INSERT INTO TAREFAS VALUES (GETDATE(), 'Refatorar aplicação', 2, 'h', 'Atribuida', NULL, NULL, 
(SELECT ID FROM USUARIOS WHERE NOME = 'UsuTeste1'), (SELECT ID FROM USUARIOS WHERE NOME = 'UsuTeste3'))
INSERT INTO TAREFAS VALUES (GETDATE(), 'Complitar aplicação', 30, 'm', 'Pendente', NULL, NULL, 
